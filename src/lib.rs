...
fn init_maps() -> (RefMap, BaseMap, RefLengths) {
    ...
    let ins_maps: BaseMap = BaseMap::new();
...
/// Merge `ref_arrs` into `ins_maps` to have a single `BaseMap` containing all coordinates and counts.
